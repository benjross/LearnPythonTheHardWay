...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        print "escape pod."
        print "\n"
        print "You're running down the cenreal corridor to the Weapons Armory when"
        ...
        if action == "shoot!":
            ...
            print "The Gorthon stops, tries not to laugh, then busts out laughing and can't move."
            print "While he's laughing you run up and shoot him square in th head"
            print "putting hi down, then jump through the Weapon Armory door."
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print "You do a dive roll into the Weapon Armory, crouch and scan the quiet room"
        print "for more Gothons that mifht be giding. It's dead quiet, too quiet."
        ...
        if guess == code or guess == "007":
            ...
            print "melting osund as the mechanism is fused together."
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        print "interference. You get to the chamber with the escpae pods, and"
